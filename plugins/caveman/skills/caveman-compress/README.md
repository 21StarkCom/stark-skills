...
**Requires:** Node ≥ 22.6 (scripts run via `node --experimental-strip-types`)
...
Only two things use tokens: initial compression + targeted fix if validation fails. Everything else is local TypeScript.
