...
That reconciliation is sound only while each integration grant names the base branch's
freshly observed tip, re-read while the leader holds the merge lock.
