...
- **Cross-module interface consistency.** Signatures, return types, contracts between modules.
...
- `approve` — diff is correct and ready to merge. Minor nits go in `non_blocking_suggestions`.
