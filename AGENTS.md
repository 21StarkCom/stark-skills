...
PR landing retains `--lead` compatibility. Review audit redaction and the legacy authentication-refresh refusal remain defensive. GraphQL transport failures are surfaced without automatic mutation replay.
