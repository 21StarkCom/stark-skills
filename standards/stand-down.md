...
- **Count the surfaces in your pane before you arm**, because cmux refuses to
  ...
  them until this contract pins a minimum hermod version; on that hermod a
  mispasted id no longer produces the `not_found` shape below, because the stamp
  is ignored once your surface resolves.
