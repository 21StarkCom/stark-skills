...
Another Minion may hold overlapping files: implement anyway, then reconcile at the
rebase before merge. Raise scope outside your declared files, or a conflicting
exclusive resource, before touching it.
