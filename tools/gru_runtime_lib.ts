...
export function packet(run: Run, task: Assignment): string {
  ...
  return [
    ...
    "reconcile, rebuild, and retest, then repost your review on the new head: Gru verifies a review whose commit",
    "is the merged head, and after merging nothing can repair that evidence.",
