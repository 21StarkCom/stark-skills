...
check empty         '{}'
check pr-pending  '{"model":{"display_name":"X","id":"x"},"pr":{"number":944,"url":"https://x/pull/944","review_state":"pending"},"prompt_cache":{"warm":true,"hit_ratio":0.97,"requests":43,"miss_causes":{}}}'
check pr-approved '{"model":{"display_name":"X","id":"x"},"pr":{"number":12,"review_state":"approved"},"prompt_cache":{"warm":false,"hit_ratio":0.5,"miss_causes":{}}}'
